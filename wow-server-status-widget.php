...
<div style="text-align: <?php echo $instance['align']?>">
    <img alt="<?php echo $instance['realm'];?> realm status"
         src="<?php echo
                 WP_PLUGIN_URL.
                 '/wow-server-status-widget/wow_ss.php?'.
	...
	function form( $instance ) {
		...
		<input type="text"
                ...
                <select id="<?php echo $this->get_field_id( 'region' ); ?>"
                        ...
                        style="width:25%;"
                        >
                        <option <?php if ( 'us' == $instance['region']) echo 'selected="selected"'; ?>
                              value="us">
                               US
                        </option>
                        <option <?php if ( 'eu' == $instance['region']) echo 'selected="selected"'; ?>
                              value="eu">
                               EU
                        </option>
                </select>
                     ...
                     <tr>
                        ...
                        <td>
                            <select id="<?php echo $this->get_field_id( 'align' ); ?>"
                                ...
                                >
                                <option <?php if ( 'left' == $instance['align']) echo 'selected="selected"'; ?>
                                      value="left">
                                       Left
                                </option>
                                <option <?php if ( 'center' == $instance['align']) echo 'selected="selected"'; ?>
                                      value="center">
                                       Center
                                </option>
                                <option <?php if ( 'right' == $instance['display']) echo 'selected="selected"'; ?>
                                      value="right">
                                       Right
                                </option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="<?php echo $this->get_field_id( 'display' ); ?>"
                                ...
                                >
                                <option <?php if ( 'full' == $instance['display']) echo 'selected="selected"'; ?>
                                      value="full">
                                       Full Badge
                                </option>
                                <option <?php if ( 'half' == $instance['display']) echo 'selected="selected"'; ?>
                                      value="half">
                                       Half Badge
                                </option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="<?php echo $this->get_field_id( 'img_type' ); ?>"
                                ...
                                >
                                <option <?php if ( 'png' == $instance['img_type']) echo 'selected="selected"'; ?>
                                      value="png">
                                       PNG
                                </option>
                                <option <?php if ( 'gif' == $instance['img_type']) echo 'selected="selected"'; ?>
                                      value="gif">
                                       GIF
                                </option>
                            </select>
